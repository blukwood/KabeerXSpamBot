...
@exploiter.on_message(filters.command('delspam'))
...
@exploiter.on_message(filters.command('spam'))
...
@exploiter.on_message(filters.command('fastspam'))
...
@exploiter.on_message(filters.command('slowspam'))
